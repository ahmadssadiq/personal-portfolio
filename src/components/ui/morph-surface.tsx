    ...
    <>
      ...
      <textarea
        ...
        className={cn(
          ...
          "bg-background dark:bg-background rounded-b-lg rounded-t-xs border border-border",
          "caret-primary",
...
function Kbd({
  ...
  return (
    <kbd
      className={cn(
        "w-6 h-6 bg-background text-foreground rounded flex items-center justify-center font-sans px-[6px] text-xs border border-border shadow-sm",
        className
      )}
    >
      {children}
